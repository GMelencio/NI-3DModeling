...
' - Size: <a href="#" onclick="size=5;buildGeo(geo,size);">5</a> ' +
        ...
        ' - Use your mouse to zoom, pan and rotate. ' +
        '<a href="https://github.com/jaanga/gestification/tree/gh-pages/cookbook/draw-3d-objects" target="_blank">Source code</a>.' +
...
function buildGeo() {
    ...
    material = new THREE.MeshBasicMaterial( { color: 0xffffff * Math.random(), ambient: 0xff0000, opacity: 0.7});
    //material = new THREE.MeshNormalMaterial({ color: 0x00fff0 })
        ...
        for (var i = 0; i < 5; i++) {
            ...
            if (i < len) {
                ...
                if (len === 1 && hand) {
                    ...
                    drawGeo.material = new THREE.MeshNormalMaterial({ color: 0xffffff * Math.random(), ambient: 0xff0000, opacity: 0.7 });
                }
            } else {
